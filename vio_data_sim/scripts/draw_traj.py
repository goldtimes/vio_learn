...
quaterntions1 = []
timestamp1 = []
data = np.loadtxt(filepath + '/imu_integ_pose.txt')
# timestamp1 = data[:,0]
...
quaterntions2 = []
timestamp2 = []
data = np.loadtxt(filepath + '/imu_integ_noise_pose.txt')
# timestamp2 = data[:,0]
...
ax.plot(position1[:,0], position1[:,1], position1[:,2], label='imu_inte')
